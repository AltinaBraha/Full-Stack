...
<head>
    ...
    <!-- Bootstrap CSS për stilimin e faqes -->
    ...
    <!-- Stili i brendshëm për përmirësimin e dizajnit të faqes -->
    <style>
        html, body {
            height: 100%;
        }
...
<body class="text-center">
    <!-- Forma për regjistrim që do të dërgojë të dhënat në register.php -->
    <main class="form-signin">
        <form action="register.php" method="post">
            <!-- Logoja Bootstrap si imazh -->
            ...
            <!-- Checkbox për mbajtjen mend të hyrjes -->
            ...
            <!-- Link për kyçje nëse tashmë ke një llogari -->
